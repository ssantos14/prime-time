...
chrome.runtime.onInstalled.addListener(function() {
   // the extension will set a value using the storage API
   // this allows multiple extension components to access that value and update it
   // note: the storage API must be registered under the "permissions" field in the manifest
